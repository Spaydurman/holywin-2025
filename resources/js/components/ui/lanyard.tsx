...
function Band({ maxSpeed = 50, minSpeed = 0, cardText = "YOUR TEXT" }: BandProps) {
  ...
  const { nodes, materials } = useGLTF('/images/lanyard/card.glb') as any;
  const texture = useTexture('/images/lanyard/lanyard.png');
